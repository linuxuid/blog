            ...
            <div class="contacts_description">
                ...
                <div class="contacts_content">
                    ...
                    <h3>
                        ...
                        <p> 
                            <strong>Ответ:</strong> Нет. Считаю что политические темы не имеют никакого конструктива, так как у всех разные взгляды и все верять в то во что хотят верить, не думаю что вообще данное обсуждение принесет кому-то хоть какую-то пользу кроме как разжигание ненависти друг к другу.
                        </p>
                    ...
                    <h3>
                        Вопрос: Будет ли дальнейшее развитие?
                    </h3>
                        <p>
