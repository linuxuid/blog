    ...
    <div class="content">
        <div class="rules_content">
            <div class="description">
                <h2>Примечания:</h2>
                    <p>
                        На данном сайте вы можете найти огромное количество <strong><i>"полярного"</i></strong> контента от программирования до политики, тут нет никакой цензуры для обсуждения чего-либо.
                    </p>
                    <p>
